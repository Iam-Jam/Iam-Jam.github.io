...
function _drawCards(mapped_properties) {
    ...
    let PropertiesHtml = mapped_properties.map( (property) => {
        ...
        const {TransactionType, PropertyClassification, PropertyType, Price, PropertyName, Location, LotArea, FloorArea, Bedrooms,Bathrooms,PropertyImage,TitleStatus } = property;
        return `
                <div class='col-lg-4 col-md-6 mb-4'>
                    <div class="card property-item rounded overflow-hidden">
                        <div class="position-relative overflow-hidden">
